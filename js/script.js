...
const appData = {
    ...
    reset: function () {
        ...
        const saveMe = screens[0];

        saveMe.querySelector('select').disabled = false;
        saveMe.querySelector('input').value = '';
        saveMe.querySelector('input').disabled = false;
        saveMe.querySelector('select').value = '';
